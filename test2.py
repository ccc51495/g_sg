...
def draw_tree(screen,x,y):
    pygame.draw.rect(screen,green,([21+x*30,21+y*30],[28,28]))

def draw_river(screen,x,y):
    pygame.draw.rect(screen,blue,([21+x*30,21+y*30],[28,28]))

def draw_sand(screen,x,y):
    pygame.draw.rect(screen,sand,([21+x*30,21+y*30],[28,28]))

def draw_mountain(screen,x,y):
    pygame.draw.rect(screen,red,([21+x*30,21+y*30],[28,28]))

def draw_ice(screen,x,y):
    pygame.draw.rect(screen,ice,([21+x*30,21+y*30],[28,28]))

def draw_smallmountain(screen,x,y):
    pygame.draw.rect(screen,grey,([21+x*30,21+y*30],[28,28]))

def draw_white(screen,x,y):
    pygame.draw.rect(screen,background,([21+x*30,21+y*30],[28,28]))
